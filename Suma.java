...
public class Suma{
  public static void main(String args[]){
    ...
    System.out.print("¿cuanto tienpo de antiguedad tiene el trabajador?");
   ...
   if (clave == 1) {
     ...
     if (antiguedad == 2) {
       ...
       System.out.println("El trabajador " + nombre + " tiene derecho a 22 dias de vacaciones");
        ...
        System.out.println("El trabajador " + nombre + " tiene derecho a todo las vacaciones que quiera");
     }
   }else if(clave == 3){
     if (antiguedad == 3) {
       ...
       System.out.println("Error!, la clave no es correcta " );
     }
   }
  }
